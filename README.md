...
> This project is **100% vibe-coded** — written entirely through AI-assisted development with Claude Code, with thorough human review and guidance at every step. Why is that fine? It's a read-only tool that posts PR comments. The worst it can do is post a bad review.
